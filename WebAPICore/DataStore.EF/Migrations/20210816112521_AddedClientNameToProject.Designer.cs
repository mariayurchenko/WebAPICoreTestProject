...
namespace DataStore.EF.Migrations
{
    ...
    [Migration("20210816112521_AddedClientNameToProject")]
    partial class AddedClientNameToProject
    {
            ...
            modelBuilder.Entity("Core.Models.Ticket", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            TicketId = 2,
                            DueDate = new DateTime(2021, 8, 4, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Owner = "Maria Yurchenko",
                            ProjectId = 1,
                            ReportDate = new DateTime(2021, 8, 4, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Title = "Bug #2"
                        },
                        new
                        {
                            ...
                            Owner = "Maria Yurchenko",
                            ProjectId = 2,
                            ReportDate = new DateTime(2021, 10, 4, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Title = "Bug #3"
                        });
                });
